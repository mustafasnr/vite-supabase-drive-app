  ...
  (
    ...
    const onDrop = useCallback(
      (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
        ...
        const newRejected: FileRejection[] = [...rejectedFiles];
          ...
          if (file.size > MAX_SIZE) {
            newRejected.push({
              ...
              errors: [
                {
                  code: "file-too-large",
                  message: `${file.name} ${MAX_SIZE / 1024 / 1024}MB'den büyük. `,
                },
              ],
            });
          } else {
        ...
        if (validFiles.length === 0) {
          toast.error("Dosya(lar) şartları sağlamıyor");
          return;
        }
